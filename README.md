...
It is powered by the [blackmagic](https://codeberg.org/blackmagic-debug/blackmagic) project.
...
- All the debug features and supported targets of the [blackmagic](https://codeberg.org/blackmagic-debug/blackmagic) firmware:
